...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是JP,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JP', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '高中生，爱技术与艺术', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jpblog.xyz', // 网站地址
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/409616512?spm_id_from=444.41.0.0', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/channel/UCCqL_KS1GUBQRDmtIwXG3ug', // Youtube主页
